...
本專案為 HW5 Advanced Topic 作業，包含三個 AI / Automation 應用實作，並皆提供可運作之 Streamlit Demo 與 GitHub 原始碼。
...
## Q3 — PPT 換版型（AI 重新設計）
- 功能：上傳 PPT，自動輸出兩種不同設計風格
- 技術：python-pptx + Streamlit
- 風格：
  - Style A：Dark / Neon
